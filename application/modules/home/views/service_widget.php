...
<section class="services-section" id="services">
    <div class="container">
        <header class="service-header-v3">
            ...
            <h2 class="service-title-v3">Our <span>Services</span></h2>
            <p class="service-desc-v3">Comprehensive moving solutions designed to make your relocation smooth, safe, and stress-free.</p>
        </header>
