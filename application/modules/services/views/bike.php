                ...
                <div class="col-lg-8">
                    <div class="service-content-wrapper p-4 p-lg-5 bg-white rounded-4 shadow-sm border-0 position-relative">
                        <div class="image-wrapper mb-5 rounded-4 overflow-hidden position-relative shadow-lg">
                            <img src="<?= base_url('assets/images/bike_transportation_hero.png') ?>" alt="Bike Transportation" class="img-fluid w-100 bike-hero-img">
                            <div class="image-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                                <div class="text-center text-white">
                                    <i class="bi bi-shield-check display-1 text-orange mb-3 d-block"></i>
                                    <h3 class="fw-bold tracking-wide text-uppercase">100% Scratch-Free Delivery</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 mt-2 mb-5">
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Multi-Layer Packing</h5>
                                    <p class="small text-muted mb-0">We use bubble wrap, corrugated sheets, and stretch film to protect against scratches and transit shocks.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">GPS Tracking</h5>
                                    <p class="small text-muted mb-0">Stay informed with real-time tracking of your bike's location throughout the journey.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Transit Insurance</h5>
                                    <p class="small text-muted mb-0">Comprehensive coverage options for complete peace of mind against any unforeseen circumstances.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <p class="small text-muted mb-0">Convenient pickup from your doorstep and safe delivery directly to your new address.</p>
                                </div>
                            </div>
                        </div>

                        <!-- Process Timeline -->
                        <h3 class="fw-bold mb-4 border-bottom pb-3">How We Move Your Bike</h3>
                        <div class="process-timeline ms-3 border-start border-warning border-3 position-relative ps-4 py-2">
                            <div class="timeline-step mb-4 position-relative">
                                ...
                                <h5 class="fw-bold text-dark">1. Inspection & Packing</h5>
                                <p class="text-muted small">We conduct a thorough pre-move condition check, remove mirrors if necessary, and apply multi-layer protective packaging.</p>
                            </div>
                            <div class="timeline-step mb-4 position-relative">
                                <div class="step-dot position-absolute bg-warning rounded-circle"></div>
                                <h5 class="fw-bold text-dark">2. Secure Loading</h5>
                                <p class="text-muted small">Using hydraulic ramps and heavy-duty tie-down straps, we securely mount your bike inside our specialized enclosed carriers to prevent any movement.</p>
                            </div>
                            <div class="timeline-step position-relative">
                                <div class="step-dot position-absolute bg-warning rounded-circle"></div>
                                <h5 class="fw-bold text-dark">3. Safe Delivery</h5>
                                <p class="text-muted small">Your bike is delivered to your designated address, carefully unloaded, and unpacked for your final inspection.</p>
                            </div>
                        </div>
    ...
    <section class="bottom-cta-section py-5 position-relative overflow-hidden">
        ...
        <div class="container position-relative z-1 py-4">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <h2 class="display-5 fw-bold text-white mb-4">Ready to Relocate Your Bike safely?</h2>
