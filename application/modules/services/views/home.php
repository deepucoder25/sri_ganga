<main class="main">
    <section class="custom-service-banner" style="background-image: url('<?= base_url("assets/images/service_banner_bg.png") ?>');">
        <div class="banner-content">
            <h1 class="banner-title align-self-center">Home Shifting</h1>
            <div class="banner-breadcrumb">
                <a href="<?= site_url() ?>"><i class="bi bi-house-door-fill"></i> Home</a> 
                <span class="separator">/</span> 
                <span class="current">Home Shifting</span>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8">
                    <div class="service-content-wrapper p-4 p-lg-5 bg-white rounded-4 shadow-sm border-0 position-relative">
                        <div class="image-wrapper mb-5 rounded-4 overflow-hidden position-relative shadow-lg">
                            <img src="<?= base_url('assets/images/home_shifting_hero.png') ?>" alt="Home Shifting Services" class="img-fluid w-100 bike-hero-img">
                            <div class="image-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                                <div class="text-center text-white">
                                    <i class="bi bi-house-heart display-1 text-orange mb-3 d-block"></i>
                                    <h3 class="fw-bold tracking-wide text-uppercase">Stress-Free Moving</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 mt-2 mb-5">
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Premium Packing</h5>
                                    <p class="small text-muted mb-0">We use high-grade corrugated boxes, bubble wrap, and specialized packing paper for fragile items.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Secure Transportation</h5>
                                    <p class="small text-muted mb-0">Your belongings travel in weather-proof, GPS-enabled trucks driven by experienced professionals.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Careful Loading</h5>
                                    <p class="small text-muted mb-0">Our trained professionals use modern equipment to safely load and unload heavy furniture and appliances.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Unpacking & Setup</h5>
                                    <p class="small text-muted mb-0">We don't just deliver; we help unpack and arrange your furniture in your new home upon request.</p>
                                </div>
                            </div>
                        </div>

                        <!-- Process Timeline -->
                        <h3 class="fw-bold mb-4 border-bottom pb-3">Our Moving Process</h3>
                        <div class="process-timeline ms-3 border-start border-warning border-3 position-relative ps-4 py-2">
                            <div class="timeline-step mb-4 position-relative">
                                ...
                                <h5 class="fw-bold text-dark">1. Pre-Move Survey</h5>
                                <p class="text-muted small">We assess your moving requirements and provide a detailed, transparent quotation tailored to your needs.</p>
                            </div>
                            <div class="timeline-step mb-4 position-relative">
                                <div class="step-dot position-absolute bg-warning rounded-circle"></div>
                                <h5 class="fw-bold text-dark">2. Expert Packing</h5>
                                <p class="text-muted small">On moving day, our team arrives with all materials to safely pack your entire household.</p>
                            </div>
                            <div class="timeline-step position-relative">
                                <div class="step-dot position-absolute bg-warning rounded-circle"></div>
                                <h5 class="fw-bold text-dark">3. Safe Delivery</h5>
...
<li>Fragile or premium items</li>
                        ...
                        <div class="accordion elite-accordion" id="homeFaq">
    ...
    <section class="bottom-cta-section py-5 position-relative overflow-hidden">
        ...
        <div class="container position-relative z-1 py-4">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <h2 class="display-5 fw-bold text-white mb-4">Ready to move into your new home?</h2>
                    <p class="lead text-white-50 mb-5">Join thousands of satisfied families who have trusted us with their precious household belongings. Get a custom quote in minutes.</p>
