<main class="main">
    <section class="custom-service-banner" style="background-image: url('<?= base_url("assets/images/service_banner_bg.png") ?>');">
        <div class="banner-content">
            <h1 class="banner-title align-self-center">Office Shifting</h1>
            <div class="banner-breadcrumb">
                <a href="<?= site_url() ?>"><i class="bi bi-house-door-fill"></i> Home</a> 
                <span class="separator">/</span> 
                <span class="current">Office Shifting</span>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8">
                    <div class="service-content-wrapper p-4 p-lg-5 bg-white rounded-4 shadow-sm border-0 position-relative">
                        <div class="image-wrapper mb-5 rounded-4 overflow-hidden position-relative shadow-lg">
                            <img src="<?= base_url('assets/images/office_shifting_hero.png') ?>" alt="Office Shifting Services" class="img-fluid w-100 bike-hero-img">
                            <div class="image-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                                <div class="text-center text-white">
                                    <i class="bi bi-building display-1 text-orange mb-3 d-block"></i>
                                    <h3 class="fw-bold tracking-wide text-uppercase">Zero Downtime</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 mt-2 mb-5">
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">IT & Server Relocation</h5>
                                    <p class="small text-muted mb-0">Expert handling of servers, computers, and delicate electronic equipment with specialized anti-static packaging.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Minimal Downtime</h5>
                                    <p class="small text-muted mb-0">We plan meticulously to ensure your office move is completed over weekends or after hours if needed.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Confidentiality Guaranteed</h5>
                                    <p class="small text-muted mb-0">Secure packing and moving of sensitive documents, archives, and proprietary business materials.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="feature-card p-4 rounded-4 bg-light h-100 border transition-all">
                                    ...
                                    <h5 class="fw-bold">Workstation Setup</h5>
                                    <p class="small text-muted mb-0">We dismantle and expertly reassemble office furniture, cubicles, and conference room setups.</p>
                                </div>
                            </div>
                        </div>

                        <!-- Process Timeline -->
                        <h3 class="fw-bold mb-4 border-bottom pb-3">Our Corporate Moving Process</h3>
                        <div class="process-timeline ms-3 border-start border-warning border-3 position-relative ps-4 py-2">
                            <div class="timeline-step mb-4 position-relative">
                                ...
                                <h5 class="fw-bold text-dark">1. Relocation Planning</h5>
                                <p class="text-muted small">We assign a dedicated move manager to coordinate with your team and create a seamless timeline.</p>
                            </div>
                            <div class="timeline-step mb-4 position-relative">
                                <div class="step-dot position-absolute bg-warning rounded-circle"></div>
                                <h5 class="fw-bold text-dark">2. Color-Coded Packing</h5>
                                <p class="text-muted small">We use a structured tagging system so items end up in the exact correct department at the new location.</p>
                            </div>
                            <div class="timeline-step position-relative">
                                <div class="step-dot position-absolute bg-warning rounded-circle"></div>
                                <h5 class="fw-bold text-dark">3. Swift Execution</h5>
                                <p class="text-muted small">Our team works efficiently to transport and set up your new office so you can resume business immediately.</p>
                            </div>
                        </div>
    ...
    <section class="bottom-cta-section py-5 position-relative overflow-hidden">
        ...
        <div class="container position-relative z-1 py-4">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <h2 class="display-5 fw-bold text-white mb-4">Ready to relocate your office with zero hassle?</h2>
                    <p class="lead text-white-50 mb-5">Join hundreds of businesses who have trusted us with their corporate relocations. Get a custom quote in minutes.</p>
